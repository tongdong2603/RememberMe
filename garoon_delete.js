...
const cloudUrl = "https://test-dev-16.cybozu.com/g/";
const tokenCloud = '1.9SYORcichbP2gusdn-tOaUEEAQEMya__zuE73S_mqp9JpvcV';
let isRunning = 1;
...
function clear() {
  ...
  axios.get(`${cloudUrl}${uriApi}?limit=1000&rangeStart=2020-06-22T12%3A00%3A00%2B09%3A00`, {
    ...
    await resp.data.events.forEach((el,i) => {
      ...
      // if (el.subject ==='eddit Let\'s go for lunch') {
        setTimeout(function() {
